...
import { TStructureMapStructure } from '../partials/StructureMapStructure';
import { TCanonical } from '../simpleTypes/Canonical';
import { TStructureMapGroup } from '../partials/StructureMapGroup';

export type TStructureMap = {
  resourceType?: string;
  id?: string;
  meta?: TMeta;
  implicitRules?: TUri;
  ...
  purpose?: TMarkdown;
  copyright?: TMarkdown;
  structure?: TStructureMapStructure[];
  import_?: TCanonical[];
  group: TStructureMapGroup[];
};
